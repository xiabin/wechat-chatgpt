...
import {RequestValue} from "./request.js";
import {Response, ResponseValue} from "./response.js";
...
export class SparkDesk {
    ...
    get tokenLength():SparkDeskOption['tokenLength']{
        return this.option.tokenLength
    }
